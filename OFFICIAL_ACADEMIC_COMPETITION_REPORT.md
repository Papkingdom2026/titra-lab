...
graph TD
    ...
    E --> F["Phase 6: Quiz (10 ข้อ)<br/>(แบบทดสอบท้ายบทเรียนปรนัย & อัตนัย พร้อมเฉลย)"]
    F --> G["Phase 7: Certificate<br/>(ประเมิน ⭐⭐⭐⭐⭐ 5 ดาว & ออกเกียรติบัตร A4/PNG)"]
```

1. **ระบบประเมิน 6 เฟสการสืบสวน (6-Phase Inquiry Progression):**
   ...
   * **Phase 3 (Analysis):** ประเมินทักษะปฏิบัติการไทเทรต 3 ซ้ำ โดยผู้เรียนสังเกตจุดยุติสีชมพูระเรื่อที่ $2.82 - 2.84\text{ mL}$ และบันทึกปริมาตรด้วยตนเอง
   * **Phase 4 (Calculation):** ประเมินการคิดวิเคราะห์ 4 ขั้นตอน: 1) การตรวจหา Outlier (Trial 3 = 3.56 mL) 2) การคำนวณปริมาตรเฉลี่ย $\bar{V} = 2.84\text{ mL}$ 3) การคำนวณความเข้มข้น $C_1 = 0.01136\text{ M}$ จาก $C_1V_1 = C_2V_2$ และ 4) การคำนวณมวลวิตามินซี ($500\text{ mg}$ ใน 250 mL หรือ $50.0\text{ mg}$ ใน 25.00 mL)
   ...
   * **Phase 6 (Post-Lab Assessment - 10 Questions):** แบบทดสอบท้ายบทเรียน 10 ข้อ (ปรนัย 6 ข้อ และอัตนัยคำนวณสั้น 4 ข้อ) พร้อมระบบตรวจให้คะแนนและแสดงคำอธิบายหลักการวิทยาศาสตร์อย่างละเอียด
2. **ระบบการประเมินเกียรติบัตรและดาว 5 ระดับ (⭐⭐⭐⭐⭐ Dual-Factor 5-Star Rating Engine):**
   * ⭐⭐⭐⭐⭐ **ระดับยอดเยี่ยม 5 ดาว (Master Forensic Expert):** คะแนน $\ge 1,100\text{ XP}$ และทำแบบทดสอบได้ $\ge 9/10\text{ ข้อ}$ (เกียรตินิยมเหรียญทอง)
   * ⭐⭐⭐⭐ **ระดับดีเด่น 4 ดาว (Senior Forensic Analyst):** คะแนน $\ge 950\text{ XP}$ และทำแบบทดสอบได้ $\ge 7/10\text{ ข้อ}$ (เกียรตินิยมเหรียญเงิน)
   * ⭐⭐⭐ **ระดับดี 3 ดาว (Professional Chemical Investigator):** คะแนน $\ge 750\text{ XP}$ และทำแบบทดสอบได้ $\ge 5/10\text{ ข้อ}$ (เกียรตินิยมเหรียญทองแดง)
   * ⭐⭐ **ระดับผ่านเกณฑ์ 2 ดาว (Assistant Forensic Analyst):** คะแนน $\ge 500\text{ XP}$ หรือทำแบบทดสอบได้ $\ge 3/10\text{ ข้อ}$ (ระดับพื้นฐาน)
   * ⭐ **ระดับฝึกหัด 1 ดาว (Trainee Forensic Analyst):** คะแนน $< 500\text{ XP}$ หรือทำแบบทดสอบได้ $< 3/10\text{ ข้อ}$
...
*ภาพที่ 5: Phase 4 - แบบฟอร์มตรวจหา Outlier, คำนวณความเข้มข้นสารละลาย C1 = 0.01136 M และคำนวณมวลวิตามินซี*
...
![ภาพใบประกาศเกียรติคุณฉบับทางการ Phase 7](file:///C:/Users/asuwa/.gemini/antigravity-ide/brain/690a9192-e63b-40a8-a710-4d11e7772e0f/forensic_certificate_1787024805996.png)
*ภาพที่ 7: Phase 7 - หน้าแสดงผลประเมิน 5 ดาว สรุปผลสอบแบบทดสอบ 10 ข้อ เหรียญรางวัล และใบประกาศเกียรติคุณฉบับสมบูรณ์*
...
2. **ปฏิกิริยาการไทเทรตกรดแอสคอร์บิกและการวิเคราะห์ Outlier (Titration & Gross Error Rejection):**
   ...
   * **ผลการทดลอง 3 ซ้ำ (Triplicate Titration Data):**
     - $\text{Trial 1}: 2.82\text{ mL}$ (จุดยุติชมพูระเรื่อ)
     - $\text{Trial 2}: 2.84\text{ mL}$ (จุดยุติชมพูระเรื่อ)
     - $\text{Trial 3}: 3.56\text{ mL}$ (มีฟองอากาศค้างปลายบิวเรตต์ $\rightarrow$ จัดเป็น **Gross Systematic Error / Outlier**)
   * **การคำนวณปริมาตรเฉลี่ยที่ถูกต้อง ($\bar{V}$):**
     $$\bar{V} = \frac{2.82 + 2.84}{2} = 2.84\text{ mL}$$
   * **การคำนวณความเข้มข้นของกรดในตัวอย่าง ($C_1$):**
     $$C_1V_1 = C_2V_2 \implies C_1 \times (25.00\text{ mL}) = (0.1000\text{ M}) \times (2.84\text{ mL})$$
     $$C_1 = 0.01136\text{ M (Mol/L)}$$

3. **การคำนวณมวลวิตามินซีและร้อยละเทียบกับฉลากโภชนาการ (Nutritional Label Verification):**
   * มวลโมเลกุลของกรดแอสคอร์บิก ($\text{C}_6\text{H}_8\text{O}_6$) $= 176.12\text{ g/mol}$
   * ในตัวอย่าง $25.00\text{ mL}$ มีวิตามินซี $= 50.0\text{ mg}$
   * ในเครื่องดื่มทั้งขวด $250\text{ mL}$ มีวิตามินซีรวม $= 500\text{ mg (หรือ } 0.500\text{ g)}$
   * หากตรวจพบ $498\text{ mg}$ จากฉลาก $500\text{ mg}$ คิดเป็นร้อยละ $= 99.6\%$
